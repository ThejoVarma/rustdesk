...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("config_acc", "In order to control your Desktop remotely, you need to grant GetRytRemote \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant GetRytRemote \"Screen Recording\" permissions."),
        ...
        ("setup_server_tip", "Please set the ID Server value as remote.getryt.in in Settings -> Network"),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow GetRytRemote to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [GetRytRemote Input] service."),
        ...
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next GetRytRemote application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant GetRytRemote \"Input Monitoring\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running GetRytRemote."),
        ("config_microphone", "In order to speak remotely, you need to grant GetRytRemote \"Record Audio\" permissions."),
        ...
        ("enter_rustdesk_passwd_tip", "Enter GetRytRemote password"),
        ("remember_rustdesk_passwd_tip", "Remember GetRytRemote password"),
        ("login_linux_tip", "You need to login to remote Linux account to enable a X desktop session"),
        ("verify_rustdesk_password_tip", "Verify GetRytRemote password"),
